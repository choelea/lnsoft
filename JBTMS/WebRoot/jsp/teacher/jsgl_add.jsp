...
<html>
	<head>
		...
		function isExist(param0,param1,param2){
			if(param2!=""){
	...
	<body>
		<html:form action="/jsgl.do?method=saveObject" onsubmit="return isNull()">
			<table align="center" width="100%" border="0" cellpadding="0"
				...
				<tr height="35px">
					...
					<td>
						<html:text styleClass="input" property="vo.jsbh"
							onblur="isExist(0,'jsbh',this.value)"></html:text>
						&nbsp;&nbsp;&nbsp;
				...
				<tr height="35px">
					<td colspan="2" align="center">
						<html:hidden property="vo.kfxg" value="1"/>
						<input type="submit" name="tijian" value="添 加" class="inputbutton">
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
