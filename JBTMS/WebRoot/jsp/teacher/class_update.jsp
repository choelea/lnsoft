...
<html>
	<head>
		...
		function testTeachInfo(param1,param2,param3){
			if(param2!=""){
				var param0 = document.getElementById("vo.bjzj").value;
				UserDWR.isExistBjxx(param0,param1,param2,cd1);
			}
		}
		function cd1(data){
			flag1 = data;
	...
	<body>
		<html:form action="/class.do?method=updateObject" onsubmit="return isNull()">
			<table align="center" width="100%" border="0" cellpadding="0"
				cellspacing="1" style="word-break:break-all;">
				<tr height="40px">
					<td colspan="2" align="center">
						<span class="bt">班级信息修改</span>
					</td>
				</tr>
				<tr height="35px">
				...
				<tr height="35px">
					<td colspan="2" align="center">
						<html:hidden property="vo.bjzj"/>
						<html:hidden property="vo.bhzdz"/>
						<input type="submit" name="tijiao" value="修 改" class="inputbutton">
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
