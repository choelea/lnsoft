...
<html>
	<head>
    	...
    	function valiValue(o){
    		if(o.value!=""){
    			UserDWR.isExit("from Sjxx where sjbh =? ",o.value,function cd(data){
	...
	<body>
		<html:form action="/sjxx.do?method=addObject" method="post"
			...
			<table width="100%" align="center" cellpadding="0" cellspacing="1"
				...
				<tr>
					...
					<td>
						<html:text property="sjbh" styleClass="input"
							onblur="valiValue(this);" />
						<html:hidden property="cjrzj" value="${userPk }" />
						<div id="bjbh" class="spts"></div>
					</td>
					<td align="right">
						任务名称&nbsp;&nbsp;
					</td>
					<td>
						<html:text property="sjmc" styleClass="input" />
					</td>
				</tr>
				<tr>
					<td align="right">
				...
				<tr>
					<td colspan="4" align="center">
						...
						<img src="<%=request.getContextPath()%>/images/button/export.jpg"
							id="show-btn2" alt="点击选择" style="cursor:hand;" />
					</td>
				</tr>
				<tr>
					<td colspan="4" align="center">
				...
				<tr>
					<td align="center" colspan="4">
						...
						<html:submit styleClass="inputbutton" styleId="submitbut">添 加</html:submit>
						<input type="button" value="返 回" class="inputbutton"
							onclick="back();" />
			...
			<div id="hello-tabs2">
				<div style="height: 330px;overflow: auto">
					<table border="0" width="100%" style="word-break:break-all;" cellpadding="0" cellspacing="1">
						<tr align="center" height="30">
							<td>
								全选<input type="checkbox" id="delpk" onClick="return selAll();">
							</td>
							<td>
								操作名称
							</td>
						...
						<logic:notEmpty name="list">
							<logic:iterate id="obj" name="list">
								<tr align="center" height="25">
									<td>
										<input type="checkbox" name="lsid" value="${obj.stzj}" />
