    ...
    <html:form action="/sjzdmx.do?method=updObject" method="post" onsubmit="return IsNull();">
    	<table width="100%" align="center" cellpadding="0" cellspacing="1" border="0" style="word-break:break-all;">
    		...
    		<tr>
    			...
    			<td>
    				<html:text property="hpxx.hpbm" styleClass="input" readonly="true"/>
    				<span id="hpbm"></span>
    				<html:hidden property="sjzd.sjzdzj" value="${objPk }"/>
    				<html:hidden property="vo.fqzj" value="${fqPk }"/>
    				<html:hidden property="hpxx.hpzj"/>
    			</td>
    			<td align="right">货品名称&nbsp;&nbsp;</td>
    			<td>
    				<html:text property="hpxx.hpmc" styleClass="input" onblur="valiValue1(this,'hpmc');"/>
    				<span id="hpmc"></span>	
    				<input type="hidden" name="oldName" value="${sjzdForm.hpxx.hpmc }"/>
    			</td>
    		</tr>
    		<tr>
