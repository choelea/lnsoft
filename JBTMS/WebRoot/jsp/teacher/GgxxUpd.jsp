...
<html>
  <head>
    ...
    <script type="text/javascript">
    	...
    	function pagedata(curpage){
    		UserDWR.claPagedata("",curpage,null,cd);
    	}	
    	function cd(data){
  ...
  <body>
    <html:form action="/ggxx.do?method=updObject" method="post" onsubmit="return IsNull();">
	    ...
	    <div id="hello-tabs">
           <div class="tanchuang" id="div1">
    		...
    		<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					<td align="right">
						共 [${pageinfo.allpage }] 页&nbsp;&nbsp;当前第 [${pageinfo.curpage }] 页 &nbsp;&nbsp;每页 [${pageinfo.pagerecord }] 条记录&nbsp;&nbsp;<input type="button" name="first" class="inputbutton3"	onClick="pagedata(1);"/><input type="button" name="before" class="inputbutton1" onClick="pagedata(${pageinfo.previouspage });"/><input type="button" name="next" class="inputbutton2" onClick="pagedata(${pageinfo.nextpage });"/><input type="button" name="last" class="inputbutton4" onclick="pagedata(${pageinfo.allpage });"/>						
					</td>
				</tr>
			</table>
            </div>
