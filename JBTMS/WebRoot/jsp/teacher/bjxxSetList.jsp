...
<html>
	...
	function pagedata(page,count){
			...
			if(!exp.test(page)){
				...
				window.location.href="./testSetup.do?method=bjxxList&page="+page;
			}
	}
	</script>
		<c:if test="${!empty msg}">
	...
	<body>
		<html:form action="/testSetup.do?method=bjxxList" method="post">
			<table align="center" width="100%" border="0" cellpadding="0"
				...
				<c:forEach var="obj" items="${pageinfo.pagedata }">
					<tr align="center" height="25">
						...
						<td>
							<a href="./testSetup.do?method=groupList&classPk=${obj.bjzj}">实 验 组</a>
						</td>
					</tr>
				</c:forEach>
