  ...
  <body>
  	<html:form action="/khts.do?method=tsslObject" method="post">
    		...
    		<tr>
    			...
    			<td colspan="3">
    				<html:textarea property="vo.slhf" cols="50" rows="4"></html:textarea>
    			</td>
    		</tr>
    		<tr>
    		...
    		<tr>
    			<td align="center" colspan="4">
    				...
    				<input type="submit" value="受 理" class="inputbutton" onclick="return IsNull();"/>
