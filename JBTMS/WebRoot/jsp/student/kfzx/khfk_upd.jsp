...
<html>
	...
	function getPagedata(curpage){
		...
		var countHql = " select count(*) from Yspsd A inner join A.khht B inner join B.khdd C inner join C.khxxByKhzj D inner join C.khxxByKhxKhzj E where A.ssxs = ${userPk} and A.sssysz = ${userSyszzj} and A.yszt = 4 ";
	...
	<body onload="getHt(${khfkForm.yspsd.ysdzj});">
		<html:form action="/khfk.do?method=update" method="post" onsubmit="return isNull();">
			<table align="center" width="100%" border="0" cellpadding="0"
				...
				<tr>
					<td colspan="4" align="center">
						...
						<html:hidden property="vo.khfkzj"/>
						<html:hidden property="vo.ssxs" />
    					<html:hidden property="vo.sssysz" />
						<html:hidden property="vo.fkzt" />
