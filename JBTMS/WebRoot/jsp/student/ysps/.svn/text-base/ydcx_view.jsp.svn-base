...
<html>
	<head>
		...
		<script type="text/javascript">
			function back(){
	    		window.location.href="<%=request.getContextPath()%>/ydcx.do?method=getList&page=1";
	    	}
	    	 function toChild(){
	...
	<body >
		<html:form action="/ydcx.do?method=getList" method="post" >
			<div id="printId">
			<table width="100%" align="center" cellpadding="0" cellspacing="1"
				border="0" style="word-break:break-all;">
				<caption><center>运单信息</center></caption>
				<tr>
					<td width="25%" align="right">运单单号&nbsp;&nbsp;</td>
					<td width="25%">
						<html:text property="vo.ysddbh" readonly="true" styleClass="input"/>
					</td>
					<td width="20%" align="right">运单类型&nbsp;&nbsp;</td>
					<td >
