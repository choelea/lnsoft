...
<html>
	...
	<body onload="getHt(${ddzj});">
		<html:form action="/send.do?method=getList&address=qs" method="post">
		<div id="printId">
			<table width="100%" align="center" cellpadding="0" cellspacing="1"
				border="0" style="word-break:break-all;">
				<caption><center>配送订单信息</center></caption>
				<tr>
				...
				<tr>
					<td  align="right">签 收 人&nbsp;&nbsp;&nbsp;&nbsp;</td>
					<td>
						<html:text property="vo.shrqz" styleClass="input" readonly="true"/>
					</td>
					<td align="right">签收日期&nbsp;&nbsp;&nbsp;&nbsp;</td>
					<td>
						<html:text property="vo.shrqzsj" styleClass="input" readonly="true" />
					</td>
				</tr>
				<tr>
					<td colspan="4">
