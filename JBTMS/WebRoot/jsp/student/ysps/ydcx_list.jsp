...
<html>
	...
	<body>
		<html:form action="/ydcx.do?method=query" method="post">
				...
				<logic:notEmpty name="pageinfo" property="pagedata">
					<logic:iterate id="obj" name="pageinfo" property="pagedata"
						...
						<tr align="center">
							...
							<td>
								<a href="<%=request.getContextPath()%>/ydcx.do?method=view&vo.ysddzj=${obj.ysddzj}">${obj.ysddbh}</a>
							</td>
							<td>
							...
							<td>
								<a href="<%=request.getContextPath()%>/ydcx.do?method=view&vo.ysddzj=${obj.ysddzj}">详 细</a>
							</td>
						</tr>
					</logic:iterate>
				</logic:notEmpty>
