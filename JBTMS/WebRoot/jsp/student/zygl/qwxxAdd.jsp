...
<html>
  ...
  <body>
    <html:form action="/qwxx.do?method=addObject" method="post" onsubmit="return IsNull();">
		<table width="100%" align="center" cellpadding="0" cellspacing="1" border="0" style="word-break:break-all;" >
    		...
    		<tr >
    			...
    			<td>
    				<html:text property="vo.qwmc" styleClass="input" onblur="valiValue(this,'qwmc','${qwxxForm.kfxx.kfzj }')"/>
    				<span id="qwmc"></span>
    			</td>
    		</tr>
    		<tr>
