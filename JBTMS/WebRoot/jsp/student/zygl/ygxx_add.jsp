...
<html>
  ...
  <script type="text/javascript" src="./js/newdate.js"></script>
    <html:form action="/yggl.do?method=saveObject" method="post" onsubmit="return IsNull();">
    	<table width="100%" align="center" cellpadding="0" cellspacing="1" border="0" style="word-break:break-all;" >
    		<caption><center>员工录入</center></caption>
    		<tr >
    		...
    		<tr>
    			...
    			<td colspan="3">
    				<html:text property="vo.ygdz" styleClass="inputlong"/>
    			</td>
    		</tr>
    		<tr>
    		...
    		<tr>
    			<td align="center" colspan="4" class="td2">
    				...
    				<html:hidden property="vo.ygzt" value="0"/>
