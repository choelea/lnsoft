...
<link rel="stylesheet" type="text/css" href="./css/newdate.css" />
  ...
  <script type="text/javascript" src="./js/newdate.js"></script>
    <html:form action="/sbwxjl.do?method=addObject" method="post" onsubmit="return isNull();">
  		<table align="center" width="100%" border="0" cellpadding="0" cellspacing="1" style="word-break:break-all;">
  			...
  			<tr>
  				...
  				<td width="25%">
  					...
  					<html:hidden property="vo.ssxtmk" value="${curGwzj}"/>
  			...
  			<tr>
  				...
  				<td><html:text property="vo.zdr" styleClass="input" readonly="true" value="${userTName }"/></td>
  			</tr>
  			<tr>
