...
<html>
  ...
  <body>
    <html:form action="/kfxx.do?method=updObject" method="post" onsubmit="return IsNull();">
		<table width="100%" align="center" cellpadding="0" cellspacing="1" border="0" style="word-break:break-all;" >
    		...
    		<tr >
    			...
    			<td>
    				<html:text property="vo.kfmc" styleClass="input" onblur="valiValue1(this,'kfmc','${userPk }','${userSyszzj }')"/>
    				<input type="hidden" name="oldName" value="${kfxxForm.vo.kfmc }"/>
    				<span id="kfmc"></span>
    			</td>
    		</tr>
    		<tr>
