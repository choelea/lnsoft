...
<script type="text/javascript">
	...
	function getParamterB(curpage,zdlx,obj){
		...
		UserDWR.getPageinfo(countHql, hql, curpage,10, 16,cda);
		var etr = obj.parentNode.parentNode;
		var etd = etr.firstChild.lastChild;
	...
	function cda(data){
		...
		"<tr align='center' height='30'><td width='10%'>选择<input type='hidden'name='infokind' value='cllx'/></td><td width='30%'>站点名称</td><td width='30%'>地区名称</td></tr>";
		for(var obj in list){
			if(!isNaN(obj)){
  ...
  <body>
  	<html:form action="/bxgl.do?method=save" method="post" onsubmit="return isNull();">
  		<table align="center" width="100%" border="0" cellpadding="0" cellspacing="1" style="word-break:break-all;">
  			<caption><center>班线录入</center></caption>
  			<tr>
  				<td align="right" width="25%">班线编号&nbsp;&nbsp;</td>
  				<td width="25%" colspan="3">
  					<html:text property="vo.bxbh" styleClass="input" value="${autoBh }" readonly="true"/>
  				</td>
  			</tr>
  			<tr>
