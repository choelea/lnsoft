...
<html>
  ...
  <body>
  	<html:form action="/cwtj.do?method=swCbCwtj" method="POST">
    <table align="center" border="0" cellpadding="0" cellspacing="0">
		<tr>
			...
			<td>
			&nbsp;&nbsp;&nbsp;&nbsp;
				<input type="button" value="报 表" class="inputbutton" onclick="javaScript:window.location.href='<%=request.getContextPath() %>/cwtj.do?method=swCbBb&ny=${ny }'">
			</td>
		</tr>
		</table>
	</html:form>
