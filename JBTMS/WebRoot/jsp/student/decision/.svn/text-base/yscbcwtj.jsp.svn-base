...
<html>
  ...
  <body>
  	<html:form action="/cwtj.do?method=ysCbCwtj&kind=${kind }" method="POST">
    <table align="center" border="0" cellpadding="0" cellspacing="0">
		<tr>
			...
			<td>
			&nbsp;&nbsp;&nbsp;&nbsp;
				<input type="button" value="报 表" class="inputbutton" onclick="javaScript:window.location.href='<%=request.getContextPath() %>/cwtj.do?method=ysCbBb&kind=${kind }&ny=${ny }'">
			</td>
		</tr>
		</table>
	</html:form>
