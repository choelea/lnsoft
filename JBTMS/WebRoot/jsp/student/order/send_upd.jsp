...
<html>
	...
	<script type="text/javascript" src="<%=request.getContextPath()%>/js/newdate.js"></script>
		<html:form action="/send.do?method=update&address=send" method="post" onsubmit="return IsNull();">
			<table width="100%" align="center" cellpadding="0" cellspacing="1"
				border="0" style="word-break:break-all;">
				<caption><center>配送订单修改</center></caption>
				<tr>
					<td width="20%" align="right">配送单号&nbsp;&nbsp;&nbsp;&nbsp;</td>
					<td width="25%">
