...
<html>
  ...
  <script type="text/javascript" src="./js/newdate.js"></script>
  	<html:form action="/ykdd.do?method=updObject" method="post" onsubmit="return IsNull();">
    		...
    		<tr>
    			...
    			<td align="right" width="20%">计划日期<font color="red">*</font>
    				...
    				<input type="hidden" name="ykfssjg" id="ykfssjg" value="${kfxx.ssjg }"/>
    				<input type="hidden" name="ykflx" id="ykflx" value="${kfxx.kflx }"/>
    			</td>
    			<td >
    				...
    				<tbody id="mxId">
	    				...
	    				<logic:iterate id="ykmx" name="list" indexId="i">
	    					<tr align="center" id="${i }">
		    					<td>${i+1 }</td>
		    					<td><input type='text' name='list[${i }].yqw.qwmc' readonly='readonly' class='inputsmall2' value='${ykmx.cwxxByCwzj.qwxx.qwmc }' style='cursor:hand;' onclick='yqwPagedata(1,${i });'>
		    					...
		    					<td>
		    					<input type='text' name='list[${i }].ycw.cwbh' readonly='readonly' class='inputsmall2' value='${ykmx.cwxxByCwzj.cwbh }' style='cursor:hand;' onclick='ycwPagedata(1,${i });'>
		    					...
		    					<td><input type='text' name='list[${i }].mbqw.qwmc' readonly='readonly' class='inputsmall2' style='cursor:hand;' value="${ykmx.cwxxByCwxCwzj.qwxx.qwmc }" onclick='mbqwPagedata(1,${i });'>
		    					...
		    					<td><input type='text' name='list[${i }].mbcw.cwbh' readonly='readonly' class='inputsmall2' style='cursor:hand;' onclick='mbcwPagedata(1,${i });' value="${ykmx.cwxxByCwxCwzj.cwbh }">
		    					...
		    					<td><input type='text' name='list[${i }].ykhpsl' class='inputsmall2' value="${ykmx.ykhpsl }" style='cursor:hand;' onblur='IsNumFormat(${i });'></td>
		    					<td><input type='text' name='list[${i }].ykshsl' class='inputsmall2' value="${ykmx.ykshsl }" style='cursor:hand;' onblur='IsNumFormat(${i });'></td>
		    					<td><img src='./images/button/del.gif' alt='点击删除' style='cursor:hand;' onclick='delTrE(this);'></td>
		    				</tr>
	    				</logic:iterate>
    				</tbody>
    			</table>
