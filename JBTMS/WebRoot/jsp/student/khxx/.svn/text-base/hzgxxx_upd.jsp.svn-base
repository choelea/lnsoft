...
<html>
  <head>
    ...
    <script type="text/javascript">
    	...
    	function IsNull(){
    		...
    		dForm.action="<%=request.getContextPath()%>/hzgxxx.do?method=update";
    		dForm.method="post";
    		dForm.submit();
    		return true;
    	}
    	...
    	function valiValue(o,f){
    		if(o.value!=""){
    			var oldHzdbh = document.all("oldHzdbh");
    			if(o.value==oldHzdbh.value){
    				bhexist = false;
    			}else{
    	...
    	function pageCdata(curpage){
    		var countHql = "select count(*) from Khxx where 1=1 and ssxs = ${userPk} and sssysz = ${userSyszzj}";
			var hql = " from Khxx where 1=1 and ssxs = ${userPk} and sssysz = ${userSyszzj}";
  ...
  <body>
  	<html:form action="/hzgxxx.do?method=update" method="post">
  		  <table width="100%" align="center" cellpadding="0" cellspacing="1" border="0" style="word-break:break-all;">
    		<caption><center>合作关系修改</center></caption>
    		<tr>
    			...
    			<td width="25%">
    				...
    				<div id="hzdbh"></div>
    				<input type="hidden" name="oldHzdbh" value="${hzgxxxForm.vo.hzdbh }"/>
    			</td>
