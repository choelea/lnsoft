...
.inputlong {	
    ...
    <script type="text/javascript">
    	function IsNull(){
    		...
    		var stxxs = document.getElementsByName("stxx");    		
    		if(stxxs.length==0){
    			return true;
    		}else{
    			for(var i=0;i<stxxs.length;i++){
    				if(stxxs[i].checked){
    					return true;
    				}
    			}
  ...
  <body>
    <html:form action="/stglExam.do?m=save" method="post" styleId="example" onsubmit="return IsNull();">
    	<table width="100%" align="center" cellpadding="0" cellspacing="1" border="0" style="word-break:break-all;">
    		...
    		<tr align="center">
    			<td>
    			<textarea id="vo.stmc" name="vo.stmc" cols="100" rows="8" style="visibility: hidden" ></textarea>
    			</td>
    		</tr>
